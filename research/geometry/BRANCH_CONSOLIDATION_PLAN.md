...
`00fcabf7f01557fb81b3aafdf04711aff13d2e48`. The current candidate has since
added only the bounded commits reported in the final handoff. No merge, rebase, deletion,
...
| `verification-reconciliation-slice2-decision` | `00fcabf7f01557fb81b3aafdf04711aff13d2e48` | no upstream; current worktree | candidate; +6 from default at audit | this reconciliation, tests, and records | proposed PR source |
